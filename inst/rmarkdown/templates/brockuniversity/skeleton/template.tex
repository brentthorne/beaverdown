% This is the Brock University LaTeX template. To the best of my
% knowledge, most of the work was done by the beaverdown team.

%%
%% Preamble
%%
% \documentclass{<something>} must begin each LaTeX document
\documentclass[onehalf,11pt]{brocktex}
% Added by CII
