...
date: 'January 1, 2018'            # date of submission
commencement: '2018'               # year of commencement
degree: 'Doctor of Philosophy'     # Masters of Science, Art, etc. 
major: 'Earth Sciences'
depttype: 'Faculty of Math and Science Brock University'                 # Department, College, etc.
depthead: 'Head'                   # Chair, Chancellor, Interim Head, etc.
department: 'Department of Earth Science'
advisor: 'Dr. Jane R. Doe'
#
...
output: 
  brockdown::thesis_pdf: default
#  brockdown::thesis_gitbook: default
#  brockdown::thesis_word: default
#  brockdown::thesis_epub: default
...
#
abstract: >
  `r if(knitr:::is_latex_output()) brockdown::inc("pre/00-abstract.Rmd")`
# If you'd rather include the preliminary content in files instead of inline
# like below, use a command like that for the abstract above.  Note that a tab is 
# needed on the line after the >.
acknowledgements: >
  `r if(knitr:::is_latex_output()) brockdown::inc("pre/00-acknowledgements.Rmd")`
contributors: > 
  `r if(knitr:::is_latex_output()) brockdown::inc("pre/00-contributors.Rmd")`
dedication: >
